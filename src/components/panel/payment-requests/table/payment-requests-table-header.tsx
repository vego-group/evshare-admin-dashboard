...
function PaymentRequestsTableHeader() {
  return (
    <thead>
      <tr className="bg-primary/8 text-base font-semibold leading-6 text-dark-gray">
        <TableHead className="w-[211px]">الاسم</TableHead>
        <TableHead className="w-[180px]">رقم الجوال</TableHead>
        <TableHead className="w-[156px]">المبلغ</TableHead>
...
export default PaymentRequestsTableHeader;
