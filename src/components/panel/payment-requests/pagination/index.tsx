...
import type { PaymentRequestsPaginationMeta } from "@/types";

type PaymentRequestsPaginationProps = {
...
function PaymentRequestsPagination({
  meta,
  onPageChange,
}: PaymentRequestsPaginationProps) {
...
export default PaymentRequestsPagination;
