...
import type { VatPaginationMeta } from "@/types";

type VatPaginationProps = {
  meta?: VatPaginationMeta;
  onPageChange: (page: number) => void;
};

function VatPagination({ meta, onPageChange }: VatPaginationProps) {
