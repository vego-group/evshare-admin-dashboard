...
type ProductOrdersToolbarSelectProps<T extends string> = {
  label: string;
  options: T[];
  value: T;
...
function ProductOrdersToolbarSelect<T extends string>({
  label,
  options,
  value,
  onChange,
}: ProductOrdersToolbarSelectProps<T>) {
...
export default ProductOrdersToolbarSelect;
