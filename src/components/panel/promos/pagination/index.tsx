...
import type { PromoCodesPaginationMeta } from "@/types";

type PromosPaginationProps = {
  meta?: PromoCodesPaginationMeta;
  onPageChange: (page: number) => void;
};

function PromosPagination({ meta, onPageChange }: PromosPaginationProps) {
...
export default PromosPagination;
