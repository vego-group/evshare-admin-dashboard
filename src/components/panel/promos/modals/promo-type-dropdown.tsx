...
import type { PromoContext } from "@/types";

const typeOptions: { label: string; value: PromoContext }[] = [
  { label: "طلبات", value: "order" },
  { label: "اشتراكات", value: "subscription" },
  { label: "طلبات واشتراكات", value: "both" },
];

function PromoTypeDropdown({
  value,
  setValue,
}: {
  value: PromoContext;
  ...
  const selectedLabel = typeOptions.find((option) => option.value === value)?.label;
...
export default PromoTypeDropdown;
