...
function VehicleDeleteConfirmModal({ open, vehicleName, isDeleting, onClose, onConfirm }: Props) {
  return (
    <Modal
      open={open}
      onClose={onClose}
    ...
    >
      <div className="space-y-5 p-1 text-center">
        ...
        <p className="text-sm leading-6 text-dark-gray">
          هل تريد حذف {vehicleName ?? "هذه المركبة"}؟ لا يمكن التراجع عن هذا الإجراء.
        </p>
...
export default VehicleDeleteConfirmModal;
