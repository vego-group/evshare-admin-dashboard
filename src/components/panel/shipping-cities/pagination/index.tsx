...
import type { ShippingCitiesPaginationMeta } from "@/types";

type ShippingCitiesPaginationProps = {
  meta?: ShippingCitiesPaginationMeta;
  onPageChange: (page: number) => void;
};

function ShippingCitiesPagination({
  meta,
  onPageChange,
}: ShippingCitiesPaginationProps) {
...
export default ShippingCitiesPagination;
