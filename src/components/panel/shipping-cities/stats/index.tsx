import { shippingCitiesStatConfig } from "@/data";
import type { ShippingCitiesAnalytics } from "@/types";

type ShippingCitiesStatsProps = {
  data?: ShippingCitiesAnalytics;
};

function ShippingCitiesStats({ data }: ShippingCitiesStatsProps) {
  return (
    <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 xl:grid-cols-4">
      {shippingCitiesStatConfig.map((stat) => {
...
export default ShippingCitiesStats;
