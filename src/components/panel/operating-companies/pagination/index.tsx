...
import type { OperatingCompaniesPaginationMeta } from "@/types";

type OperatingCompaniesPaginationProps = {
  meta?: OperatingCompaniesPaginationMeta;
  onPageChange: (page: number) => void;
};

function OperatingCompaniesPagination({
  meta,
  onPageChange,
}: OperatingCompaniesPaginationProps) {
...
export default OperatingCompaniesPagination;
