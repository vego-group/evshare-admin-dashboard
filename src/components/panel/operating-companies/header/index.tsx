...
export type OperatingCompaniesViewMode = "table" | "card";

type OperatingCompaniesHeaderProps = {
  viewMode: OperatingCompaniesViewMode;
  onViewModeChange: (viewMode: OperatingCompaniesViewMode) => void;
};

function OperatingCompaniesHeader({
  viewMode,
  onViewModeChange,
}: OperatingCompaniesHeaderProps) {
  return (
    <section className="flex w-full flex-col gap-5 sm:flex-row sm:items-center sm:justify-between">
      <Header
        title="الشركات المشغلة"
        subtitle="إدارة شركات تشغيل الأسطول العاملة على المنصة"
      />
...
export default OperatingCompaniesHeader;
