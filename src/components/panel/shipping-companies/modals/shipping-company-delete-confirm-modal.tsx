...
type ShippingCompanyDeleteConfirmModalProps = {
  companyName?: string;
  open: boolean;
  isDeleting: boolean;
  onClose: () => void;
...
function ShippingCompanyDeleteConfirmModal({
  companyName,
  open,
  isDeleting,
  onClose,
  onConfirm,
}: ShippingCompanyDeleteConfirmModalProps) {
  return (
    <Modal
      open={open}
      onClose={onClose}
      ...
      <div className="mx-auto flex w-full max-w-[481px] flex-col items-center justify-center gap-6 text-center">
        ...
        <div className="space-y-2">
          ...
          <p className="text-base font-medium leading-6 text-[#667085]">
            لا يمكن حذف شركة مرتبطة بشحنات قائمة، ويمكنك تعطيلها بدلًا من ذلك.
          </p>
        </div>
...
export default ShippingCompanyDeleteConfirmModal;
