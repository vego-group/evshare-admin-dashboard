...
import type { ShippingCompaniesPaginationMeta } from "@/types";

type ShippingCompaniesPaginationProps = {
  meta?: ShippingCompaniesPaginationMeta;
  onPageChange: (page: number) => void;
};

function ShippingCompaniesPagination({
  meta,
  onPageChange,
}: ShippingCompaniesPaginationProps) {
...
export default ShippingCompaniesPagination;
