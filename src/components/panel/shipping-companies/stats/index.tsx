import { shippingCompaniesStatConfig } from "@/data";
import type { ShippingCompaniesAnalytics } from "@/types";

type ShippingCompaniesStatsProps = {
  data?: ShippingCompaniesAnalytics;
};

function ShippingCompaniesStats({ data }: ShippingCompaniesStatsProps) {
  return (
    <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 xl:grid-cols-3">
      {shippingCompaniesStatConfig.map((stat) => {
...
export default ShippingCompaniesStats;
