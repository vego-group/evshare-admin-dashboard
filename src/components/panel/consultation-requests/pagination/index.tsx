...
type ConsultationRequestsPaginationProps = {
  meta?: PaginationMeta;
  onPageChange: (page: number) => void;
};

function ConsultationRequestsPagination({
  meta,
  onPageChange,
}: ConsultationRequestsPaginationProps) {
...
export default ConsultationRequestsPagination;
