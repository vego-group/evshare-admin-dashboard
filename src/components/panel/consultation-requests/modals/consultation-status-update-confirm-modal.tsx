...
function ConsultationStatusUpdateConfirmModal({
  open,
  isUpdating,
  requestName,
  targetStatus,
      ...
      <div className="mx-auto flex w-full max-w-120.25 flex-col items-center justify-center gap-6 text-center">
        ...
        <div className="space-y-2">
          <h2 className="text-2xl font-medium leading-8 text-[#344054]">
            هل أنت متأكد أنك تريد تغيير حالة طلب الاستشارة{" "}
          ...
          <p className="text-base font-medium leading-6 text-[#667085]">
            سيتم تحديث حالة طلب الاستشارة بعد تأكيد هذا الإجراء.
          </p>
        </div>
...
export default ConsultationStatusUpdateConfirmModal;
