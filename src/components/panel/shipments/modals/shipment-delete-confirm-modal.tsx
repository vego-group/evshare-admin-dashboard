...
type ShipmentDeleteConfirmModalProps = {
...
function ShipmentDeleteConfirmModal({
  shipmentLabel,
  open,
  isDeleting,
  onClose,
  onConfirm,
}: ShipmentDeleteConfirmModalProps) {
  return (
    <Modal
      open={open}
      onClose={onClose}
      ...
      <div className="mx-auto flex w-full max-w-[481px] flex-col items-center justify-center gap-6 text-center">
        ...
        <div className="space-y-2">
          ...
          <p className="text-base font-medium leading-6 text-[#667085]">
            سيتم حذف الشحنة وسجل حالاتها بشكل نهائي، ولا يمكن حذف شحنة تحركت
            فعليًا — يمكنك إلغاؤها بدلًا من ذلك.
          </p>
        </div>
...
export default ShipmentDeleteConfirmModal;
