...
function ShipmentsContentShimmer() {
  return (
    <section className="space-y-6" aria-hidden="true">
      ...
      <div className="overflow-hidden rounded-lg bg-white">
        <div className="min-w-[1000px]">
          <div className="grid grid-cols-8 gap-4 border-b border-neutral-100 bg-neutral-50 px-5 py-4">
          ...
          {Array.from({ length: 5 }).map((_, rowIndex) => (
            <div
              key={rowIndex}
              className="grid h-16 grid-cols-8 items-center gap-4 border-b border-neutral-100 px-5 py-3"
            >
...
export default ShipmentsContentShimmer;
