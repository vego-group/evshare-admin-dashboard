...
type AppVersionsPaginationMeta = {
  currentPage: number;
  lastPage: number;
  perPage: number;
  total: number;
...
type AppVersionsPaginationProps = {
  meta?: AppVersionsPaginationMeta;
  onPageChange: (page: number) => void;
};

function AppVersionsPagination({
  meta,
  onPageChange,
}: AppVersionsPaginationProps) {
...
export default AppVersionsPagination;
