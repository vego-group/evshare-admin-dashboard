...
export type OrdersViewMode = "table" | "card";
...
function OrdersHeader({ viewMode, onViewModeChange }: OrdersHeaderProps) {
  return (
    <section className="flex w-full flex-col gap-5 sm:flex-row sm:items-center sm:justify-between">
      <Header title="الطلبات" subtitle="إدارة ومتابعة الطلبات" />
