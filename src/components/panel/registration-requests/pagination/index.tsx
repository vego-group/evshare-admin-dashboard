...
type RegistrationRequestsPaginationProps = {
  meta?: PaginationMeta;
  onPageChange: (page: number) => void;
};

function RegistrationRequestsPagination({
  meta,
  onPageChange,
}: RegistrationRequestsPaginationProps) {
...
export default RegistrationRequestsPagination;
