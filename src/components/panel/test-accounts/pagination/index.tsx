...
import type { TestAccountsPaginationMeta } from "@/types";

type TestAccountsPaginationProps = {
  meta?: TestAccountsPaginationMeta;
  onPageChange: (page: number) => void;
};

function TestAccountsPagination({ meta, onPageChange }: TestAccountsPaginationProps) {
...
export default TestAccountsPagination;
